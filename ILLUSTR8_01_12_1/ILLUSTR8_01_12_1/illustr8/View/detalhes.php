    ...
    <div id="container">
        <?php
            foreach ( $postagem as $post ) {
                $_SESSION['POSTAGEM'] = ['id' => $postagemDTO->getIdPostagem()];
                    ...
                    <div class="post" style="display: block;">
                        ...
                        <div class="content">
                            ...
                            <div class="espaco_botao">
                                ...
                                <a class="excluir" onclick="confirmExclusaoPost()">Excluir Post</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content">
                ...
                <form action="../Control/editarPostagemControl.php" method="POST">
                              ...
                              <div class="input-whapper">
                                    <input type="hidden" name="POSTAGEM_ID" value="<?=$postagem[0]["ID"]?>">
