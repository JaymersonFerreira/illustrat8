    ...
    <div id="container">
        ...
        <section id="title">
            <section class="post" style="display: block;">
                <form action="pesquisarPosts.php" method="POST">
                
                
                    <h1 class="h1Pesquisa">Posts</h1>
        ...
        <?php 
            ...
            $sql = $con->query("SELECT * FROM postagens WHERE titulo = '$titulo'");
                ...
                if($sql->rowCount()>0){
                    ...
                    $con = Conexao::getInstance();
                    $sql = $con->query("SELECT * FROM postagens WHERE titulo LIKE '%$titulo%'");
