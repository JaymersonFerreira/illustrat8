...
<body id="page-posts">
    <div id="container">
        ...
        <section id="title">
            ...
            <h1>Posts de <?=$user[0]["NICKNAME"]?></h1>
        </section>
        <main>
            <section id="posts">
                <?php
                $postagemDTO = new PostagemDTO();
                $postagemDTO->setUsuarioId($idPerfilVisitado);
                ...
                ?>
                    <div class="post">
                        <a href="meusPosts_comentarios.php?id=<?php echo $post["ID"] ?>">
                        ...
                        <div class="content">
                            ...
                            <div class="espaco_botao">
                                ...
                                <a href="meusPosts_comentarios.php?id=<?php echo $post["ID"] ?>">Ver mais</a>
